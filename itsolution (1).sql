...
CREATE TABLE `countings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `counting1_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counting1_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counting2_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counting2_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counting3_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counting3_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counting4_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counting4_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `delete` tinyint(1) NOT NULL DEFAULT 0,
  `created_by` bigint(20) UNSIGNED DEFAULT NULL,
  `updated_by` bigint(20) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `homepage_silders` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `slider_title` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slider_short_description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slider_link` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slider_button_text` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `logos` (
  ...
  `admin_panel_mobile_logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_panel_icon` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `main_site_header_logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `main_site_header_mobile_logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `main_site_footer_logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `main_site_footer_mobile_logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `main_site_icon` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `services` (
  ...
  `service_name_slug` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_short_details` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `teams` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `team_member_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_desig` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_gender` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_phone` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_about` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_expertise` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_exp_lavel` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_facebook` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_instagram` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_linkedin` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team_member_youtube` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `delete` tinyint(1) NOT NULL DEFAULT 0,
  `created_by` bigint(20) UNSIGNED DEFAULT NULL,
  `updated_by` bigint(20) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `units` (
  ...
  `unit_created_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
