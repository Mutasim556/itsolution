                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <form method="POST" action="{{ route('admin.backend.language.store') }}">
                                                @csrf
                                                <input type="hidden" value="{{ resource_path('views/backend') }},{{ resource_path('views/frontend') }},{{ resource_path('views/errors') }},{{ app_path('Http/Controllers') }},{{ app_path('Http/Middleware/Admin') }}" name="directory">
